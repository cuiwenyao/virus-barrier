...
*/
function adddoctorListOut($utype)
{
  ...
  '
    ...
    <form action="../../../pro/main/adddoctor.pro.php" enctype="multipart/form-data" method="POST">
      ...
      <div class="form-group">
        <label>专业</label>
        <input name="special" type="text" class="form-control" placeholder="">
      </div>
      <div class="form-group">
        <label>职位</label>
      ...
      <div class="form-group">
        <label>评价</label>
        <textarea name="workcomment"  class="form-control"></textarea>
      </div>
      <div class="form-group">
        <label>简介</label>
