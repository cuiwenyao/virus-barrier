...
*/
function updnurseListOut($utype,$did)
{
	$USER_TYPE = 100;            //模块用户权限
	$ListTitle = "修改护士信息";		 //模块标题

	if($utype!=$USER_TYPE) return false;
  require_once __DIR__."/../../../func/main.mod.func.php";
  $res = GetNurseMsg($utype,$did);
  if($res==false) return false;
  $res = mysql_fetch_assoc($res);
  echo 
  '
    <h1 class="page-header">'.$ListTitle.'</h1>
    <form action="../../../pro/main/updnurse.pro.php?nurse_id='.$did.'" enctype="multipart/form-data" method="POST">
      ...
      <a href = "./system.php?list=nurse" class="btn btn-primary" />返回</a>
    </form>
