...
INSERT INTO `isolation_test_group` VALUES ('1','admin','21232f297a57a5a743894a0e4a801fc3','2021-07-17 16:19:58','::1','100','0');
INSERT INTO `isolation_test_group` VALUES ('2','purchase','85dbdb21fe502c4d7a1e81bca0aa396d','2021-07-15 10:45:47','::1','4','0');
INSERT INTO `isolation_test_group` VALUES ('3','reception','1da95b279fc0d21024cece2c68a4c200','2021-07-17 16:18:26','::1','5','0');
INSERT INTO `isolation_test_group` VALUES ('4','zs','f6706d5db3ad094cfabd8fb5326f1eec','2021-07-15 10:44:45','::1','3','1');
INSERT INTO `isolation_test_group` VALUES ('5','cry','5054d049935d6f95316f68d1bef528af','2021-07-15 10:43:53','::1','2','1');
INSERT INTO `isolation_test_group` VALUES ('6','zdw','6f43f6b19cf54b5ce90c4e9b2ac42f67','2021-07-15 10:43:20','::1','1','1');
...
INSERT INTO `isolation_test_medicine` VALUES ('2','洛匹那韦/利托那韦','28','50','洛匹那韦利托那韦片，本品适用于与其它抗反转录病毒药物联合用药，治疗成人和2岁以上儿童的人类免疫缺陷病毒-1(HIV-1)感染。有关洛匹那韦利托那韦的用药经验主要来自于未接受过抗反转录病毒药物治疗的患者。已接受过蛋白酶抑制剂治疗的患者数据非常有限。在洛匹那韦利托那韦治疗失败的情况下对患者进行补救治疗的数据也非常有限。已接受过蛋白酶抑制剂治疗的HIV-1感染者是否选择本品治疗主要取决于两个因素，即患者个体的病毒耐药检测结果及其治疗史。');
...
INSERT INTO `isolation_test_medusing` VALUES ('3','2021-07-08 00:00:46','1','1','2','1');
